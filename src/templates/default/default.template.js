  ...
  const html = `
    <div style="display: flex; flex-direction: column; align-items: center; text-align: center; ">
      ...
      <div style="display: flex; flex-direction: column; align-items: center;">
        <h1 style="font-family: Roboto, Helvetica, Arial, sans-serif; font-size:3em; font-weight: bold; text-shadow: 3px 3px #e0e0e0; margin: 0; margin-bottom: 20px;">
          ${certificate.badge.name}
        </h1>
        <h2 style="font-family: Roboto, Helvetica, Arial, sans-serif; font-size:2.5em; text-transform: uppercase; margin:0; margin-bottom: 20px;">
        ...
        <p style="font-family: Roboto, Helvetica, Arial, sans-serif; margin: 0; margin-bottom: 50px;">
